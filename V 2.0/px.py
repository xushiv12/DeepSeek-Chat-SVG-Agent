...
def C():
    ...
    如果用户让你生成复杂的图形，比如黄色背景中有个红色爱心，你就按照它的生成：
    4444444444
    4444444444
    4222442224
    2222222222
    ...
    4444444444
    e.g:
    用户:blue背景中有个green爱心,you:
    (::7777777777 7777777777 7666776667 6666666666 7666666667 7766666677 7776666777 7777667777 7777777777 7777777777::) 
    如果用户让你生成个爱心，不管是什么颜色，什么背景，你就一定要按照这个格式不要改，只是把中间的那些2替换成其他的颜色数字，再把中间的那些4替换成背景颜色数字。
    如果用户让你生成复杂的图形，比如白色的背景，经典版的树，你就按照它的生成：
    1111661111
    1116666111
    1166666611
    1111661111
    ...
    1111001111
    1111001111
    这是经典版的绿叶黑树干,要是明确要求有什么样的叶子和树干,就按照用户的，这棵树不一定要求这个形状
